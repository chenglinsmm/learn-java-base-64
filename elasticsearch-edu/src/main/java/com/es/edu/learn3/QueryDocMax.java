...
public class QueryDocMax {
    ...
    public static void main(String[] args) {
        ConnectElasticsearch.connect(client -> {
            ...
            System.out.println(JSONChange.objToJson(hits));
            Aggregation maxAge = response.getAggregations().getAsMap().get("maxAge");
            System.out.println(JSONChange.objToJson(maxAge));
